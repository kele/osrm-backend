...
Feature: Turn Lane Guidance
    ...
    Scenario: Anticipate with lanes in roundabout
        ...
        When I route I should get
            | #           | waypoints | route       | turns                                             | lanes                                                      | #                                        |
            | right-right | a,k       | ab,cg,hk,hk | depart,roundabout-exit-1,roundabout-exit-1,arrive | ,slight right:false slight right:false slight right:true,, |                                          |
            | right-left  | a,l       | ab,cg,jl,jl | depart,roundabout-exit-1,roundabout-exit-2,arrive | ,slight right:false slight right:false slight right:true,, | no cross-roundabout anticipation yet :/  |
